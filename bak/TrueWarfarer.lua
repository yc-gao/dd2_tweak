...
local KR_FONT_NAME = "NotoSansKR-Bold.otf"
...
local Languages = {"EN", "CN","t_CN","FR","KR"}
...
re.on_draw_ui(function()
    ...
    if imgui.tree_node("True Warfarer") then
        ...
        if Config.Language == "KR" then
            local fontKR = imgui.load_font(KR_FONT_NAME, CN_FONT_SIZE, CJK_GLYPH_RANGES)
            imgui.push_font(fontKR)
        end
